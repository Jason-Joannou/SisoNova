        ...
        <>
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-muted-foreground text-sm text-center px-4">
                This represents the respondents level of comfort when using
                digital tools.
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-muted-foreground text-sm text-center px-4">
                This represents the types of devices used by respondents to
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-muted-foreground text-sm text-center px-4">
                This represents the challenges respondents face when using
                digital tools.
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-muted-foreground text-sm text-center px-4">
                This represents whether respondents have ever avoided using
                digital tools because they were worried they would make
                mistakes.
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col items-center justify-center h-[300px] space-y-4">
                ...
                <div className="text-muted-foreground text-sm text-center px-4">
                  This represents the average digital security trust based on
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-muted-foreground text-sm text-center px-4">
                This represents whether a respondent has ever stopped using a
                digital tool due to it being hard to understand or use.
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-muted-foreground text-sm text-center px-4">
                This represents the learning preference respondents have when
                learning about a new digital tool or service.
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-muted-foreground text-sm text-center px-4">
                This represents the motivators respondents have when learning
                about a new digital tool or service.
              </div>
            </CardContent>
          </Card>
