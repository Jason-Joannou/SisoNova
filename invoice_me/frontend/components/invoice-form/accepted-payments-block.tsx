    ...
    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            {componentConfig.accepted_payment_methods.map((method) => {
              ...
              return (
                <AcceptedPaymentMethodInformationModal
                  ...
                  initialData={
                    paymentInfo || initPaymentMethodInformation(method)!
                  }
                ...
                >
                  <div
                    key={method}
                    className="bg-white border border-green-200 rounded-lg p-3 shadow-sm hover:shadow-md transition-all cursor-pointer hover:border-green-300"
                  >
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {Object.values(AcceptedPaymentMethods).map(
            (method: AcceptedPaymentMethods) => {
              const isSelected =
