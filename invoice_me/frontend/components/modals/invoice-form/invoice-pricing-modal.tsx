            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-semibold text-gray-800">Always Free</h4>
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-semibold text-gray-800">Storage Only</h4>
                </div>
                <p className="text-sm text-gray-600">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-semibold text-gray-800">Start Free</h4>
                </div>
                <p className="text-sm text-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="border-2 border-blue-200 rounded-lg p-4 bg-blue-50">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h4 className="font-bold text-blue-800">Free</h4>
                    <p className="text-sm text-blue-600">50 invoices</p>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-blue-800">R0</div>
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-blue-700">30-day history</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Database className="h-3 w-3 text-blue-600" />
                    <span className="text-blue-700">Basic search</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Download className="h-3 w-3 text-blue-600" />
                    <span className="text-blue-700">PDF export</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="border-2 border-gray-200 rounded-lg p-4 bg-gray-50">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h4 className="font-bold text-gray-800">Starter</h4>
                    <p className="text-sm text-gray-600">500 invoices</p>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-gray-800">R29</div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-gray-700">Client payment history</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="border-2 border-gray-200 rounded-lg p-4 bg-gray-50">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h4 className="font-bold text-gray-800">Business</h4>
                    <p className="text-sm text-gray-600">2,000 invoices</p>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-gray-800">R79</div>
                    <div className="text-xs text-gray-600">per month</div>
                  </div>
                </div>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <Clock className="h-3 w-3 text-gray-600" />
                    <span className="text-gray-700">3-year history</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <BarChart3 className="h-3 w-3 text-gray-600" />
              ...
              <div className="border-2 border-gray-200 rounded-lg p-4 bg-gray-50">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h4 className="font-bold text-gray-800">Pro</h4>
                    <p className="text-sm text-gray-600">Unlimited</p>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-gray-800">R149</div>
                    <div className="text-xs text-gray-600">per month</div>
                  </div>
                </div>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <Clock className="h-3 w-3 text-gray-600" />
                    <span className="text-gray-700">Lifetime history</span>
                  </li>
                  <li className="flex items-center gap-2">
